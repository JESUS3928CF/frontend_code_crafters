...
const FormSupport = () => {
    return (
        <div className='flex justify-center items-center h-screen'>
            ...
            <form className='bg-white py-10 px-5 md:w-1/2 rounded-xl shadow-xl border border-black'>
                ...
                <input type="text"
                    ...
                    className='border-2 w-full p-2 mt-2 bg-#F4F8FA placeholder-gray-400 rounded-lg mb-3 focus:outline-none focus:border-sky-700 focus:ring-sky-700' />
